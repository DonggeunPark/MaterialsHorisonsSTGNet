# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 14:15:13 2024

@author: user
"""
# =============================================================================
# Crack phase fields plot
# =============================================================================
...
def time_plot(a,b,k):
    ...
    for i in range(int(a)):
        sns.heatmap(b[i*3+47*k],vmin = 0, vmax = 1,
                        cmap='bone_r' ,linecolor = 'k',linewidth=0,
                        ax = ax[i],cbar = False,
                        cbar_kws = dict(use_gridspec=True,location="top", extende = 'both',shrink = 0.3))
    #vmax = np.max(b[i*3+47*k])
        ax[i].set_xlabel(str(int(3*i+4))+'Δ', fontsize = 40)
